package net.mcreator.potnoodles;
...
@Mod("pot_noodles")
public class PotNoodlesMod {
	public static final Logger LOGGER = LogManager.getLogger(PotNoodlesMod.class);
	public static final String MODID = "pot_noodles";

	public PotNoodlesMod(IEventBus modEventBus) {
