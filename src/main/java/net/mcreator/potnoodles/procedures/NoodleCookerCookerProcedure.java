...
public class NoodleCookerCookerProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (PotNoodlesModVariables.MapVariables.get(world).NoodleCookerTime1 == 0) {
			if (3 == ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip1 ? (world.getBlockState(BlockPos.containing(x, y, z))).getValue(_getip1) : -1)) {
				{
					int _value = 4;
